...
init();})(window.publiiThemeMenuConfig);(function(){if(window.innerWidth>900){return;}
...
if(section.classList.contains('active')){section.classList.remove('active');}else{section.classList.add('active');}}})();}})();(function(){var newsletter_submit=document.querySelector('.newsletter-popup__submit');var newsletter=document.querySelector('.newsletter-popup');if(!newsletter){return false;}
...
return!!popup;}})();const sidebar=document.querySelector(".js-sidebar");input=document.querySelector('.js-search')
input.addEventListener('input',evt=>{const value=input.value
if(!value){sidebar.classList.remove("no-overflow");document.documentElement.classList.remove("no-scroll")
return}
const trimmed=value.trim()
if(trimmed){sidebar.classList.add("no-overflow");document.documentElement.classList.add("no-scroll")}else{sidebar.classList.remove("no-overflow");document.documentElement.classList.remove("no-scroll")}})